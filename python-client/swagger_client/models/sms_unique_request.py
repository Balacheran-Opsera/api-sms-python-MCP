...
class SmsUniqueRequest(object):
    ...
    """
    def __init__(self, keyid=None, date_envoi=None, sms=None, num=None, emetteur=None, tracker=None, smslong=None, nostop=None, ucs2=None):
        """
        SmsUniqueRequest - a model defined in Swagger
