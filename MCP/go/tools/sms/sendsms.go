...
func SendsmsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.SmsUniqueRequest
		...
		url := fmt.Sprintf("%s/sms", cfg.BaseURL)
...
func CreateSendsmsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_sms",
		mcp.WithDescription("Envoyer un sms"),
