...
def post_smsmulti(gmt_zone: str, smslong: str, date_envoi: str, emetteur: str, nostop: str, numAzur: str, repertoireId: str, ucs2: str, keyid: str, tracker: str, num: str, sms: str) -> str:
    """
    Envoyer des SMS
    """
    try:
