...
def post_sms(keyid: str, num: str, smslong: str, date_envoi: str, emetteur: str, gmt_zone: str, ucs2: str, tracker: str, nostop: str, numAzur: str, sms: str) -> str:
    """
    Envoyer un sms
    """
    try:
